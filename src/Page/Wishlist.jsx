  ...
  useEffect(() => {
    const fetchWishlistProducts = async () => {
      ...
      try {
        ...
        // Ensure it's always an array of productIds
        if (!Array.isArray(localWishlist)) {
          localWishlist = Object.keys(localWishlist);
        }
        
        // Format each item to have consistent structure
        const formattedItems = localWishlist.map(id => 
          typeof id === 'object' ? id : { productId: id }
        );
